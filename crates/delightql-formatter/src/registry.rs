...
pub const LAID_OUT: &[Kind] = &[
    ...
    Kind::LabelCte, Kind::LetBlock, Kind::LetFreeRelex, Kind::MapCover,
...
pub const VERBATIM: &[Kind] = &[
    ...
    Kind::ArgumentativeForm, Kind::ArgumentativeFunctor,
    ...
    Kind::AssertAnnotation, Kind::BinaryConnective, Kind::BinaryOp,
    ...
    Kind::EffectGlobHead, Kind::EffectIdentifier, Kind::EffectLabelCte,
    ...
    Kind::ExistsAsColumn, Kind::FactArm, Kind::FactBody, Kind::FactDatum,
    ...
    Kind::FunctionPipeFirst, Kind::FunctionPipeLast, Kind::FunctionPipeStep,
    ...
    Kind::KeyedBinding, Kind::KeyedValue, Kind::Lambda, Kind::LambdaBinder,
    Kind::Landing, Kind::LeadingOuterGrelex, Kind::LiftSigil,
    Kind::LowerOrderEffrelex, Kind::MarkedTarget, Kind::MatchArm,
    Kind::Materialize, Kind::Membership, Kind::Meta, Kind::MetaSigil,
    ...
    Kind::ReservedAnnotation, Kind::ReservedText, Kind::RowBound,
    Kind::ScalarParam,
    ...
    Kind::TripleTemplateText, Kind::TruthAsValue, Kind::Tuple,
