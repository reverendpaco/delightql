...
INSERT INTO identifier (kind, hierarchy, summary, explanation) VALUES
    ...
    ('error', 'semantic/resolution/ho', 'A higher-order call''s shape is ill-formed.', 'The higher-order family: how arguments and piped relations land at a functor''s parameters. Members: pipe_landing (R8 strict — the pipe lands at the first formal parameter or exactly one @, never a search, never displacement, never a scalar landing).'),
